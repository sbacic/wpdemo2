...
sleep(5); #We need to wait some time for the other tests to clean up

$I = new AcceptanceTester($scenario);
$I->wantTo('manually get an autogenerated demo session and login to the Wordpress Dashboard');
